...
namespace VirtualPet
{
    class Shelter
    {
        ...
        {
            Console.WriteLine(selectedOrganicPet.Name + " has been adopted out to a loving home.");
            listOfOrganicPets.Remove(selectedOrganicPet);
        }

        public void RemoveFromShelterRoboticList(Robotic selectedRoboticPet)
        {
            Console.WriteLine(selectedRoboticPet.Name + " has been adopted out to a loving home.");
